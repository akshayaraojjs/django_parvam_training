...
SECRET_KEY = 'django-insecure-vdfh&2cwya1jabg!byb7brc+n#f%wn#x)i_k^oxyw+772blt@6'
...
# Configuration for Handling the files
import os

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Configuration for Sharing the files for all origins
